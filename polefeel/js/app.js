...
if (isAdmin()) {
   ...
   if (location.pathname == '/polefeel/pages/people.html') {
      ...
      /*document.querySelector('.add_video_button').addEventListener('click', () => {
         document.querySelector('.add_video_card').style.display = 'flex';
      });

      document.querySelector('.add_video_card').addEventListener('click', (e) => {
         if (e.target == document.querySelector('.add_video_card')) {
            document.querySelector('.add_video_card').style.display = 'none';
         }
      });
